...
class BookDirectoryTestSuite {
    ...
    @Test
    @DisplayName("Test: listing all books of User")
    void testListOfUsersBooks(){

        LibraryUser libraryUser0Books = new LibraryUser("Joe", "0Books", "123123A");
        LibraryUser libraryUser1Book = new LibraryUser("Joe", "1Book", "123123A");
        LibraryUser libraryUser4Books = new LibraryUser("Joe", "5Books", "123123A");
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1Book)).thenReturn(resultListOf1Book);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser4Books)).thenReturn(resultListOf5Books);
